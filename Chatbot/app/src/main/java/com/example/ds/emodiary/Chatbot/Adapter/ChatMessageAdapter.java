    ...
    public void bind(final Chat chat) { //입력값에 따른 답변 텍스트의 형태 지정
        switch(chat.getAction()) {
            ...
            case ACTION_START:
                ...
                singleItem_start.add(new SingleItemModel("감정 기록하기 2", ACTION_START));
                singleItem_start.add(new SingleItemModel("감정 기록하기 3", ACTION_START));
                singleItem_start.add(new SingleItemModel("감정 기록하기 4", ACTION_START));
